...
static void module_cb_event(uint8_t button_name, uint8_t button_event) {
  ...
  switch (button_name) {
    ...
    case BUTTON_RIGHT:
      ...
      oled_screen_display_bitmap(simple_up_arrow_bmp, (128-10), scroll_pos, 8, 8, OLED_DISPLAY_NORMAL);
      oled_screen_display_bitmap(simple_down_arrow_bmp, (128-10), scroll_pos+8, 8, 8, OLED_DISPLAY_NORMAL);
