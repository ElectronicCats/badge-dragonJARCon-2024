...
typedef enum {
  ...
  MENU_INFECTION_VACCINES_MRNA,
  MENU_INFECTION_VACCINES_VIRAL_CODE,
  MENU_INFECTION_VACCINES_LIPID_LAYER,
  MENU_INFECTION_VACCINES_APPLY,
  MENU_INFECTION_VACCINES_GET,
  MENU_INFECTION_HELP,
  /* Badge finder */
...
menu_t menus[] = {  //////////////////////////////////
    ...
    {.display_name = "Vacunar",
     ...
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Ser Vacunado",
     .menu_idx = MENU_INFECTION_VACCINES_GET,
     .parent_idx = MENU_INFECTION,
     .last_selected_submenu = 0,
     .on_enter_cb = NULL,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "mRNA",
     .menu_idx = MENU_INFECTION_VACCINES_MRNA,
     .parent_idx = MENU_INFECTION_VACCINES,
     .last_selected_submenu = 0,
     .on_enter_cb = infection_vaccine_builder_mRNA,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Codigo Viral",
     .menu_idx = MENU_INFECTION_VACCINES_VIRAL_CODE,
     .parent_idx = MENU_INFECTION_VACCINES,
     .last_selected_submenu = 0,
     .on_enter_cb = infection_vaccine_builder_viral_code,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Capa Lipidica",
     .menu_idx = MENU_INFECTION_VACCINES_LIPID_LAYER,
     .parent_idx = MENU_INFECTION_VACCINES,
     .last_selected_submenu = 0,
     .on_enter_cb = infection_vaccine_builder_Lipid_layer,
     .on_exit_cb = NULL,
     .is_visible = true},
    {.display_name = "Aplicar",
     .menu_idx = MENU_INFECTION_VACCINES_APPLY,
     .parent_idx = MENU_INFECTION_VACCINES,
     .last_selected_submenu = 0,
     .on_enter_cb = infection_start_pairing,
     .on_exit_cb = infection_stop_pairing,
     .is_visible = true},
    {.display_name = "Ayuda",
